...
public class KcaInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            app_gpl.setText(Html.fromHtml(String.format(getString(R.string.ia_gpl), getString(R.string.app_name)), Html.FROM_HTML_MODE_LEGACY));
        } else {
            app_gpl.setText(Html.fromHtml((String.format(getString(R.string.ia_gpl), getString(R.string.app_name)))));
        }
