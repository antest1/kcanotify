...
public class DraggableOverlayLayout extends RelativeLayout {
    public DraggableOverlayLayout(Context context) {
        this(context, null);
    }

    public DraggableOverlayLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DraggableOverlayLayout(Context context, AttributeSet attrs, int defStyleAttr) {
